...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  i32 prints(string cstr)")
  fmt.Fprintln(os.Stderr, "  string read_action_data(i32 len)")
  fmt.Fprintln(os.Stderr, "  i32 send_inline(string serialized_action)")
